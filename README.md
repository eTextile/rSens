...
In other words this project can be compared to the Arduino map() function but instead of using software fonction you will use this hardware eTextile PCB to zoom into the sensor's significant values without losing any resolution. 
